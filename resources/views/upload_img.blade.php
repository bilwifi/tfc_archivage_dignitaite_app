 ...
 {{--    <h3 class="text-center mb-5">
    ...
    <div class="d-flex justify-content-center p-3">
        <div class="card text-center">
            <div class="card-body">
                <h5 class="card-title">{{ $dignitaire->prenom }} {{ $dignitaire->nom }}</h5>
                <div class="profile-img p-3">
                    <img src="{{ img_profil($dignitaire->iddignitaires) }}" id="profile-pic">
                </div>
                ...
                <br>
                <a href="{{ route('show_dignitaire',$dignitaire->iddignitaires) }}" class="btn btn-default">Ignorer</a>
            </div>
        </div>
    </div>
 ...
 $(function() {
    ...
    $("#upload").on("click", function() {
        croppie.result('base64').then(function(base64) {
            ...
            formData.append("iddignitaires", "{{ $dignitaire->iddignitaires }}");
                ...
                success: function(data) {
                    if (data == "uploaded") {
                       return location = "{{ route('home') }}" ;
                        ...
                        $("#profile-pic").attr("src","{{ img_profil($dignitaire->iddignitaires) }}"); 
